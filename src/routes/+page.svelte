...
<body class="h-[250px] w-[400px] bg-[#FAF3E9]">
			...
			<div>
				...
				>
					{#if playingState === 'paused'}
						<iconify-icon icon="lucide:play" style="color: white"></iconify-icon>
					{:else}
						<iconify-icon icon="lucide:pause" style="color: white"></iconify-icon>
					{/if}
				</button>
			</div>
		</div>
